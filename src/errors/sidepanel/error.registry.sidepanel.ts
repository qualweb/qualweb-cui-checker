...
import { APIError } from "./errors.class.sidepanel";
...
export interface IErrorApiHandlerArgs {
    apiError: APIError;
    callback?: () => void;
    router?:Router;
}
export interface IErrorResponseHandlerArgs {
...
export const SIDEPANEL_EXCEPTION_HANDLERS: Partial<Record<string, (args: IErrorHandlerArgs) => void>> = {
