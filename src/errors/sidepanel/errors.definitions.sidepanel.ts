...
export const UI_MESSAGE_FRIENDLY_ERRORS: Partial<Record<CombinedErrorNames, string>> = {
    ...
    [ERROR_CLASS_NAME_CONTENT.ELEMENT_NOT_FOUND_ERROR]: "The specified element could not be found on the page.",
    [ERROR_CLASS_NAME_CONTENT.CANCELLATION_ERROR]: "The operation was cancelled.",
    [ERROR_CLASS_NAME_CONTENT.INTERACTION_IN_PROGRESS_ERROR]: "An interaction is already in progress.",
    [ERROR_CLASS_NAME_CONTENT.SELECTORS_NOT_FOUND_ERROR]: "The required selectors could not be found.",
    [ERROR_CLASS_NAME_CONTENT.MESSAGE_SELECTOR_NOT_FOUND_ERROR]: "The message selector could not be found.",
    ...
    [ERROR_CLASS_NAME_CONTENT.ELEMENT_MANUAL_SELECTION_IN_PROGRESS_ERROR]: "Element selection is already in progress.",
    [ERROR_CLASS_NAME_CONTENT.OBSERVER_FOUND_NO_MESSAGES_AFTER_RETRY_ERROR]: "No messages found after retry.",
    ...
    [ERROR_CLASS_NAME_CONTENT.NO_ELEMENT_VERIFICATION_IN_PROGRESS_ERROR]: "No element verification in progress.",
    ...
    [ERROR_CLASS_NAME_BACKGROUND.CHROME_PORT_DISCONNECTED_ERROR]: "Failed to connect to the background script.",
    [ERROR_CLASS_NAME_BACKGROUND.NETWORK_ERROR]: " Port connection failed.",
    [ERROR_CLASS_NAME_BACKGROUND.LANGGRAPH_AUTHENTICATION_ERROR]: "Authentication failed. Please provide valid API key.",

    [ERROR_CLASS_NAME_SIDEPANEL.API_ERROR]: "A server error occurred while processing your request.",
    [ERROR_CLASS_NAME_SIDEPANEL.API_WITH_DETAILS]: "A server error occurred while processing your request.",
    [ERROR_CLASS_NAME_SIDEPANEL.INTERACTION_PORT_CONNECTION]: "Failed to connect to the interaction port.",
    [ERROR_CLASS_NAME_SIDEPANEL.INTERACTION_LISTENER_FAILED]: "Failed to set up interaction listener.",
