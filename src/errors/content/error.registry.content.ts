import { CallbackHandler, CallbackMessagingEvent,  MessageResponse,  STATUS } from "../../messaging/message-types";
...
export const CONTENT_EXCEPTION_PORT_HANDLERS: Record<string, { handler: (port: chrome.runtime.Port)=> boolean }> = {
    [ERROR_CLASS_NAME_CONTENT.CANCELLATION_ERROR]: {
