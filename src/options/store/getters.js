...
export const isOptionsLoaded = (state) => states.options && state.options.apiKey !== undefined && state.options.apiKey !== ''&& state.options.locale !== undefined && state.options.locale !== '';
