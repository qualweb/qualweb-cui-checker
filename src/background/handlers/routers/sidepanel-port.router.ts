import { InteractionInProgressError, UnknownError } from "../../../errors/background/errors.class.background";
...
// Handler for Sidepanel PORT .
  ...
  const onMessage = (msg: any) => {
    try {
      ...
      if (handler) {
        handler({ instanceInteractionManager: interaction, instancePortCommunication: comms, msg });
      }else {
