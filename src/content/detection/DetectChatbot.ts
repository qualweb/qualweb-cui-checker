...
import { LocalLLMResponse, detetectPageChatbotLocalLLM} from "../../assistant-interaction/detection";
  ...
  return new Promise((resolve, reject) => {
    ...
    detetectPageChatbotLocalLLM(htmlNodeText).then((response: LocalLLMResponse) => {
      ...
      console.log(" ARGS ", htmlNodeText, documentChatbot, inputElement, chatWindow);
        ...
        chatbotInterface.windowElement = documentChatbot.querySelector<HTMLElement>(chatWindowSelector);
      ...
      if (chatWindowSelector) {
        chatbotInterface.dialogElement = documentChatbot.querySelector<HTMLElement>(chatWindowSelector);
      ...
      if (LLMResponse.microphone_button) {
        ...
        chatbotInterface.microphoneElement = documentChatbot.querySelector<HTMLElement>(microphoneSelector);
