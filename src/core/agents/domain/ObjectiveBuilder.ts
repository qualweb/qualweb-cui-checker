...
export type QuestionGenerationObjective = (RawQWStandardTestData | QWBrowserTestRAW) & ObjectType & IStatusObjective ;
...
export type ObjectiveSerialized  = (RawQWStandardTestData | QWBrowserTestRAW | QWRecognitionTestRAW) & ObjectType & IStatusObjective  ;
...
export function generateQualWebTests(flagIncludeSpeechTests: boolean ): Record<string, ObjectiveSerialized> {
const QUALWEB_TESTS: Record<string, ObjectiveSerialized > = {};
  if (flagIncludeSpeechTests) {
    const QUALWEB_SPEECH_BROWSER_TESTS: Record<string, QWRecognitionTestRAW> = speechTestsRaw as Record<string, QWRecognitionTestRAW>;
 ...
 *
 */
 const QUALWEB_STANDARD_TESTS: Record<string, RawQWStandardTestData | QWBrowserTestRAW> =objectivesRaw as Record<string, RawQWStandardTestData | QWBrowserTestRAW> ;
